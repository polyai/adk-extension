# Agent Development Kit Linter

Real-time diagnostics for Agent Development Kit projects based on the cursor rules defined in `agent-deployments/.cursor/rules/`.
...
The linter activates automatically for files in Agent Development Kit projects. Diagnostics appear in:
